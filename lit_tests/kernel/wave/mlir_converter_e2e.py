...
#    lowered_mlir = apply_water_middle_end_passes(wave_dialect_mlir)
#
#    print("=== Lowered MATMUL MLIR ===")
#    print(lowered_mlir)
#
#    # Create test tensors
#    a_tensor = device_randn(64, 32, dtype=torch.float16)
#    b_tensor = device_randn(64, 32, dtype=torch.float16)  # Note: transposed in matmul
#    c_tensor = device_zeros(64, 64, dtype=torch.float32)
#
#    # Expected result (CPU computation)
